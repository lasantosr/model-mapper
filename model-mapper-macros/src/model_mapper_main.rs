        ...
        if is_try {
            ...
            quote!(
                ...
                impl #impl_generics #into_ty #into_ty_generics #where_clause {
                    ...
                    pub(crate) fn #fn_name(from: #from_ty_with_generics, #( #external_fields ),*)
            ...
            quote!(
                ...
                impl #impl_generics #into_ty #into_ty_generics #where_clause {
                    #[doc = #doc]
                    #[allow(clippy::too_many_arguments)]
                    pub(crate) fn #fn_name(from: #from_ty_with_generics, #( #external_fields ),*) -> Self {
                        let #from_ty #deconstructed_from = from;
                        Self #into_body
                    }
                }
        ...
        if is_try {
            ...
            quote!(
                ...
                impl #impl_generics #from_ty #from_ty_generics #where_clause {
                    #[doc = #doc]
                    #[allow(clippy::too_many_arguments)]
                    pub(crate) fn #fn_name(self, #( #external_fields ),*)
            ...
            quote!(
                ...
                impl #impl_generics #from_ty #from_ty_generics #where_clause {
                    #[doc = #doc]
                    #[allow(clippy::too_many_arguments)]
                    pub(crate) fn #fn_name(self, #( #external_fields ),*) -> #into_ty_with_generics {
                        let #from_ty #deconstructed_from = self;
                        #into_ty #into_body
                    }
                }
